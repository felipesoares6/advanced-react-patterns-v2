...
class Toggle extends React.Component {
  ...
  static On = ({children}) => <ToggleContext.Consumer>{value => value.on ? children : null}</ToggleContext.Consumer>
  static Off = ({children}) => <ToggleContext.Consumer>{value => !value.on ? children : null}</ToggleContext.Consumer>
  static Button = ({...props}) => (
    <ToggleContext.Consumer>{value => <Switch on={value.on} onClick={value.toggle} {...props} />}</ToggleContext.Consumer>
  )
